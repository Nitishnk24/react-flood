...
function App() {
  ...
  return (
    <Container>
      ...
      >
        <div>
          <a href="https://sites.research.google/floods/?lat=16.130262012034756&lng=2.8125&zoom=3.6">
            <button style={{}}>Click hear to get present flood road</button>
          </a>
        </div>
        <div>
          <a href="https://www.google.com/maps/@12.9794048,77.594624,12z">
            <button>Check your present location</button>
          </a>
        </div>
        <div>
          <a href="https://bhuvan-app1.nrsc.gov.in/disaster/disaster.php">
            <button>India's most flooded areas</button>
          </a>
        </div>
      </div>
      <AppLabel>Weather Info</AppLabel>
